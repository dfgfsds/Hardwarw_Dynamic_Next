    ...
    <div className="fixed inset-0 bg-black/80 flex justify-center items-center z-[999]">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="relative flex mb-6 bg-gray-100 p-1 rounded-full">
          {/* Sliding background */}
          <div
            className={`absolute top-1 left-1 w-1/2 h-[calc(100%-0.5rem)] rounded-full bg-red-600 transition-all duration-300 ease-in-out ${isOtpMode ? 'translate-x-0' : 'translate-x-full'
              }`}
          ></div>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex gap-2 justify-center py-2 px-4 rounded-md text-white bg-red-600 hover:bg-red-600"
          >
