            ...
            <div className="container mx-auto px-4 py-12">
                ...
                {matchingProductsArray?.length === 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-max  text-gray-800 animate-fadeIn">
                        ...
                        {/* <Link href="/shop">
                            <button
                                className="mt-8 px-6 py-3 font-bold bg-red-600 text-white rounded-full shadow-md hover:bg-red-600 transform transition hover:scale-105 animate-bounce"
                            >
                                Return To Shop
                            </button>
                        </Link> */}
                            ...
                            <div className=" rounded-xl overflow-hidden">
                                <div className="p-6">
                                    <div className="flex justify-between items-center mb-6">
                                        ...
                                        {/* <Link href="/shop" className="text-red-600 font-bold hover:underline text-sm flex items-center">
                                            Continue Shopping
