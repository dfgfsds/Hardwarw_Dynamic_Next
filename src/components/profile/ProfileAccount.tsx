  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex justify-end mt-6">
          <button
            ...
            disabled={loader}
            className="px-4 py-2 bg-red-600 hover:bg-red-600 font-bold text-white rounded-md"
          >
            {loader ? (
      ...
      <div className="flex justify-between items-center pt-2">
        <button
          className="px-4 py-2 bg-red-600 hover:bg-red-600 text-white font-bold rounded-md"
